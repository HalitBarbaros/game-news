...
<head>
    ...
    <style>
        ...
        /* HEADER (Flexbox for Left/Right layout) */
        header { 
        ...
        h1 { font-family: 'Oswald', sans-serif; font-size: 1.4rem; margin: 0; letter-spacing: 1px; text-transform: uppercase; }
        h1 span { color: var(--accent); }

        /* --- GOOGLE WIDGET HACKS --- */
        /* 1. Hide the Google Logo/Icon */
        .goog-te-gadget-icon { display: none !important; }
        
        /* 2. Style the Container Box to look like a Button */
        .goog-te-gadget-simple {
            background-color: rgba(255,255,255,0.1) !important; /* Glassy Dark */
        ...
        .goog-te-gadget-simple:hover { background-color: var(--accent) !important; }
        .goog-te-gadget-simple:hover span { color: #000 !important; }

        /* 3. Style the Text inside */
        ...
        /* 4. Hide the annoying 'Select Language' text if possible, showing only current lang */
        .goog-te-menu-value span:nth-child(3), .goog-te-menu-value span:nth-child(5) {
            display: none !important; /* Hides arrows/pipes */
        }

        /* 5. Hide the top banner frame Google adds */
...
"""
# ... (manifest and sw are correct and remain the same)
manifest_content = """{
  "name": "Game News",
  "short_name": "GameNews",
  "start_url": ".",
...
print("✅ Fixed: Translate Button is now a small pill in the corner")
